...
local imSize   ={64,32,16}
local channels = {1, 32,64} -- layer maps sizes
local prevE  = {channels[1]*2,channels[2]*2,channels[3]*2}
local cellCh = {channels[1],prevE[1],prevE[2]} --  Out put size of lstm -- This is same as output channels
local lstmCh = {cellCh[2]+prevE[1],cellCh[3]+prevE[2],prevE[3]} --  Out put size of lstm -- last chnel has no R_l+1 concat
clOpt['cellCh'] = cellCh
clOpt['lstmCh'] = lstmCh
